...
The canonical project tracker is the root `TODO.md`.

This file exists so documentation readers can find the project status without leaving the `docs/` folder.

## Current Priorities

- Keep documentation aligned with the actual app structure.
