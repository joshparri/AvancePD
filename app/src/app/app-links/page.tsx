...
const appLinks = [
  ...
  },
  {
    ...
    items: [
      {
        label: 'App Links Doc',
        href: 'https://docs.google.com/document/d/1rYeeXqK6QBZx1upwHdtzzoXSwxNLHz7_omcooqhUKIM/edit?tab=t.0',
      },
    ],
  },
  {
    ...
    items: [
      { label: 'JoshDashboard v1', href: 'https://joshdashboard2-3d63fzekflg2wlakjmrakz.streamlit.app/' },
      { label: 'JoshDashboard v2', href: 'https://josh-dashboard-black.vercel.app/app/dashboard.html' },
    ],
  },
  {
  ...
  {
    category: 'Whispering Wilds & related games',
    items: [
      ...
      { label: 'King Killer Chronicle Adventure', href: 'https://joshualparris.github.io/kkc-adventure/' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Mystery Depths itch.io', href: 'https://joshualparris.itch.io/mysterydepths' },
  ...
  },
  {
    ...
    items: [
      {
        label: 'Chronicles of Sword Coast',
        href: 'https://htmlpreview.github.io/?https://raw.githubusercontent.com/joshualparris/JoshHub/3de1a67/public/games/dndgame/index.html',
      },
  ...
  },
  {
    ...
    items: [
      {
        label: 'Wilds - Sail West',
        href: 'https://htmlpreview.github.io/?https://raw.githubusercontent.com/joshualparris/JoshHub/41dfcef/public/games/wilds-sail-west/index.html',
      },
      {
        label: 'Wilds Main',
        href: 'https://htmlpreview.github.io/?https://raw.githubusercontent.com/joshualparris/JoshHub/d7521ab/public/games/wilds-main/index.html',
      },
      { label: 'Delve', href: 'https://joshualparris.github.io/delve/' },
      { label: 'Breach Command', href: 'https://joshualparris.github.io/breach-command/' },
      { label: 'Echo Vault', href: 'https://joshualparris.github.io/Echo/' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      {
        label: 'Boundary Road Panos',
        href: 'https://htmlpreview.github.io/?https://raw.githubusercontent.com/joshualparris/JoshHub/3de1a67/public/games/boundary-road/index.html',
      },
      {
        label: 'Neverwinter Tales',
        href: 'https://htmlpreview.github.io/?https://raw.githubusercontent.com/joshualparris/JoshHub/8d02ac4/public/games/neverwinter-tales/index.html',
      },
  ...
  },
  {
    category: 'More games',
    items: [
      { label: 'Classic DnD Text', href: 'https://josh-hub-96no.vercel.app/games/classic-dnd-text/index.html' },
      { label: 'DND RPG Dungeon', href: 'https://josh-hub-96no.vercel.app/games/dnd-rpg-dungeon/index.html' },
      { label: 'Forbidden Quests', href: 'https://josh-hub-96no.vercel.app/games/forbidden-quests/index.html' },
      { label: 'Infinite Office', href: 'https://josh-hub-96no.vercel.app/games/infinite-office/index.html' },
      { label: 'MAX game', href: 'https://josh-hub-96no.vercel.app/games/max/index.html' },
      { label: 'Midnight Line', href: 'https://josh-hub-96no.vercel.app/games/midnight-line/index.html' },
      { label: 'NewGame', href: 'https://josh-hub-96no.vercel.app/games/newgame/index.html' },
      { label: 'OrgScape', href: 'https://josh-hub-96no.vercel.app/games/orgscape/index.html' },
      ...
      { label: 'Whirring Wilderness', href: 'https://joshuaparris-max.github.io/WhirringWilderness/' },
      { label: 'Whispering Wilds (dadlan)', href: 'https://joshuaparrisdadlan-stack.github.io/whispering-wilds/' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Waypoint Azure', href: 'https://waypoint-azure.vercel.app/' },
      { label: 'Josh Hub dashboard', href: 'https://josh-hub-two.vercel.app/dashboard' },
      { label: 'Field Notes', href: 'https://field-notes-two.vercel.app/' },
      { label: 'Parris Tech Services App', href: 'https://parris-tech-services-app.vercel.app/' },
      { label: 'DCSPD App', href: 'https://dcspd.vercel.app/' },
...
function LinkCard({ label, href }: { label: string; href: string }) {
  return (
    <a
      ...
      className="block rounded-2xl border border-slate-200 bg-white/80 p-4 text-sm font-medium text-slate-900 transition hover:border-blue-400 hover:bg-blue-50 dark:border-slate-800 dark:bg-slate-950/80 dark:text-slate-100 dark:hover:border-blue-500 dark:hover:bg-blue-950"
    >
      {label}
    </a>
  );
  ...
  return (
    <Layout>
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="mb-8 rounded-3xl border border-blue-200/60 bg-blue-50/80 p-6 shadow-sm shadow-blue-200/20 dark:border-blue-900/60 dark:bg-blue-950/20 dark:shadow-slate-950/10">
          <div className="flex items-center gap-3 text-blue-700 dark:text-blue-300">
            <Link2 className="h-6 w-6" />
            <div>
              <h1 className="text-3xl font-semibold tracking-tight sm:text-4xl">App Links</h1>
              <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">
                A curated collection of Josh’s apps, games, dashboards, and project links.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-10">
          {appLinks.map((section) => (
            <section key={section.category} className="rounded-3xl border border-slate-200 bg-white/80 p-6 shadow-sm shadow-slate-200/80 dark:border-slate-800 dark:bg-slate-950/80 dark:shadow-slate-950/10">
              <div className="mb-4 flex items-center justify-between gap-4">
                <div>
                  <h2 className="text-xl font-semibold text-slate-900 dark:text-white">{section.category}</h2>
                </div>
              </div>
              <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
                {section.items.map((item) => (
                  <LinkCard key={`${section.category}-${item.label}`} label={item.label} href={item.href} />
                ))}
              </div>
            </section>
          ))}
